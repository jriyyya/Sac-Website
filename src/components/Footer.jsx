...
const Footer = () => {
  return (
    <div className="footer mt-14 pt-16 px-8 pb-4 flex flex-col w-[96%] rounded-tr-[5rem]">
      <div className="flex flex-row  justify-around">
        <div>
          <img
            src="/assets/iiitmLogo.svg"
            alt="iiitmLogo"
        ...
        <div className="text-6xl font-extrabold flex flex-start">SAC<span className="text-[#9090DC] ">.</span></div>
      </div>
